...
def main(input_file_name, output_file_name, key_column_name="npi", time_column_name="year", first_column_clean=True,
    ...
    with h5py.File(output_file_name, "w") as f5w:
        ...
        key_values_ds = key_values_group.create_dataset("values", shape=(number_of_keys,1), dtype="S32")
...
if __name__ == "__main__":
    ...
    arg_parse_obj.add_argument("-f", "--input-file-name", default="./5year_npi_generic_NJ_small_sortbyNPI.csv", dest="input_file_name")
    arg_parse_obj.add_argument("-o", "--output-file-name", default="./5year_npi_generic_NJ_small.hdf5", dest="output_file_name")
    arg_parse_obj.add_argument("-d", "--numpy-dtype", default="int32", dest="numpy_dtype")

    arg_obj = arg_parse_obj.parse_args()
    main(arg_obj.input_file_name, arg_obj.output_file_name, numpy_dtype=arg_obj.numpy_dtype)